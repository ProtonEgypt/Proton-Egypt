...
messaging.onBackgroundMessage(function(payload){
  ...
  // ملاحظة: يُبقى هذا الرابط متطابقًا مع الرابط الافتراضي في notificationclick أدناه
  // حتى لا يفتح النقر على الإشعار عنوانًا مختلفًا عن التطبيق المنشور فعليًا.
